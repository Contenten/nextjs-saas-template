    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back, {user?.name}! Manage your application settings and
          users.
        </p>
      </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card className="col-span-full md:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  The latest actions performed in the admin panel
                </CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="settings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure admin portal settings</CardDescription>
            </CardHeader>
